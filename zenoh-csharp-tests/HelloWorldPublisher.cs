...
public class ExampleArgs
{
    ...
    [ArgShortcut("p"), ArgDefaultValue("/HelloWorldData_Msg"), ArgDescription("The name of the resource to write.")]
    public string path { get; set; }

    [ArgShortcut("v"), ArgDefaultValue("Hello World!"), ArgDescription("The value of the resource to write.")]
